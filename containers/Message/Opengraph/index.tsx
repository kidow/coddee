...
const ChatOpengraph: FC<Props> = ({
  ...
  return (
    <div className="mt-1 space-y-1 rounded border-l-4 border-neutral-200 bg-neutral-100 p-4">
      ...
      <div className="group/opengraph relative inline-block">
        <img
          ...
          tabIndex={-1}
        />
        <ul className="absolute right-2 top-2 hidden rounded border bg-white p-0.5 group-hover/opengraph:flex">
          <li>
            <button
              onClick={() => window.open(url)}
              className="flex h-8 w-8 items-center justify-center rounded text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700"
            >
